...
const OrganizationProfileSection: React.FC<OrganizationProfileSectionProps> = ({ formData, onChange, userRole }) => {
          ...
          <div className="flex items-end -mt-16 mb-4">
            ...
            <div className="ml-4 mb-2 flex-1">
              <h2 className="text-2xl font-bold text-gray-900">
                {formData.companyName || t('settings:profileEdit.organizationProfile', 'Organization Profile')}
              </h2>
