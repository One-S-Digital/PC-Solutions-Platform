...
const ProductUploadModal: React.FC<ProductUploadModalProps> = ({
  ...
  const updateVolumeTier = (
    id: string,
    key: keyof VolumePricingTierForm,
    value: string,
  ) => {
    setFormData((prev) => ({
      ...prev,
  ...
  return (
    ...
    >
      ...
      >
        ...
        <form className="flex-1 overflow-y-auto px-6 py-5 space-y-8" onSubmit={handleSubmit}>
          <Section
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <div>
                ...
                <input
                  ...
                  className={STANDARD_INPUT_FIELD}
                  maxLength={160}
                  placeholder={helper('subtitlePlaceholder', 'Highlight a key benefit')}
                />
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  placeholder={helper('descriptionPlaceholder', 'Explain how the product helps daycares.')}
                  required
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  className={STANDARD_INPUT_FIELD}
                  placeholder={helper('primaryCategoryPlaceholder', 'e.g., Educational Toys')}
                />
              ...
              <div>
                ...
                {renderChipInput(
                  ...
                  SUGGESTED_PRODUCT_CATEGORIES,
                  true,
                  helper('categoriesPlaceholder', 'Add tags like “Furniture” or “Kitchen”'),
                )}
              </div>
              ...
              <div>
                ...
                {renderChipInput(
                  ...
                  undefined,
                  true,
                  helper('highlightsPlaceholder', 'Short benefits like “Ready-to-ship”'),
                )}
              </div>
          ...
          >
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
              ...
              <div>
                ...
                <input
                  ...
                  className={STANDARD_INPUT_FIELD}
                  placeholder={helper('unitPlaceholder', 'Per item, per case, etc.')}
                />
              </div>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3 mt-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleFieldChange('stockStatus', e.target.value as StockStatus)
                  }
                  className={STANDARD_INPUT_FIELD}
                >
                  {stockOptions.map((option) => (
                    <option key={option} value={option}>
                      {t(`dashboard:stockStatus.${option.replace(/\s+/g, '').toLowerCase()}`, option)}
                    </option>
                  ))}
                </select>
              </div>
            ...
            <div className="mt-6 space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Button
                  ...
                  onClick={() =>
                    setFormData((prev) => ({
                      ...prev,
                      volumePricing: [...prev.volumePricing, emptyTier()],
                    }))
                  }
                >
              ...
              {formData.volumePricing.length === 0 && (
                <p className="text-sm text-gray-500">
                  {helper('volumePricingEmpty', 'Add tiers to incentivize larger daycare orders.')}
                </p>
              )}
                ...
                >
                  <div className="md:col-span-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateVolumeTier(tier.id, 'minQuantity', e.target.value)
                      }
                      className={STANDARD_INPUT_FIELD}
                    />
                  </div>
            ...
            <div className="mt-6 space-y-4">
              ...
              {formData.variants.length === 0 && (
                <p className="text-sm text-gray-500">
                  {helper('variantsEmpty', 'Track options like size, colour, or finish.')}
                </p>
              )}
                  ...
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                      ...
                      >
                        {stockOptions.map((status) => (
                          <option key={status} value={status}>
                            {t(
                              `dashboard:stockStatus.${status.replace(/\s+/g, '').toLowerCase()}`,
                              status,
                            )}
                          </option>
                        ))}
                    ...
                    <div>
                      ...
                      <ChipInput<string>
                        ...
                        placeholder={helper('variantAttributesPlaceholder', 'Colour, Size, Finish...')}
                      />
                    </div>
                  </div>
          ...
          >
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div>
                ...
                {renderChipInput(
                  ...
                  SUGGESTED_PRODUCT_DELIVERY_METHODS,
                  true,
                  helper('deliveryMethodsPlaceholder', 'Courier, pickup, installation...'),
                )}
              </div>
            ...
            <div className="mt-6 space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Button
                  ...
                  onClick={() =>
                    setFormData((prev) => ({
                      ...prev,
                      deliveryFees: [...prev.deliveryFees, emptyDeliveryFee()],
                    }))
                  }
                >
                  {t('common:buttons.add', 'Add')}
              ...
              {formData.deliveryFees.length === 0 && (
                <p className="text-sm text-gray-500">
                  {helper('deliveryFeesEmpty', 'List surcharge per method if applicable.')}
                </p>
              )}
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div>
                ...
                {formData.imageAssetId && (
                  <p className="text-xs text-gray-500 mt-2">
                    {helper('assetSaved', 'Saved asset ID')}: {formData.imageAssetId}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                {formData.specSheetAssetId && (
                  <p className="text-xs text-gray-500 mt-2">
                    {helper('assetSaved', 'Saved asset ID')}: {formData.specSheetAssetId}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                {formData.msdsAssetId && (
                  <p className="text-xs text-gray-500 mt-2">
                    {helper('assetSaved', 'Saved asset ID')}: {formData.msdsAssetId}
                  </p>
                )}
              </div>
            </div>
