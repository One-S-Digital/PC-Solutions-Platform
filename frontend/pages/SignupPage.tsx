    ...
    <div className="min-h-screen bg-page-bg flex flex-col items-center justify-center p-4 sm:p-6 lg:p-8">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-swiss-charcoal">{t('common:loginPage.createAccount', { appName: APP_NAME })}</h1>
          <p className="text-sm text-gray-500">{t('common:loginPage.signupSubtitle')}</p>
        </div>
