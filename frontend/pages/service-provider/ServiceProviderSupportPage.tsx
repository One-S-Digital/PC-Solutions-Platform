    ...
    <div className="space-y-8">
      ...
      <Card className="p-6">
        ...
        <form onSubmit={handleTicketSubmit} className="space-y-4">
          <div>
            <label htmlFor="ticketSubjectSp" className="block text-sm font-medium text-gray-700 mb-1">{t('supportPage.ticketForm.subjectLabel')}</label>
            <input
              type="text"
              id="ticketSubjectSp"
              value={ticketSubject}
          ...
          <div>
            <label htmlFor="ticketMessageSp" className="block text-sm font-medium text-gray-700 mb-1">{t('supportPage.ticketForm.messageLabel')}</label>
            <textarea
              id="ticketMessageSp"
              value={ticketMessage}
