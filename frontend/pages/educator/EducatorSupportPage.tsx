...
const EducatorSupportPage: React.FC = () => {
  const { t } = useTranslation(['dashboard', 'common']);
  const faqs = [
    { questionKey: "educatorSupportPage.faq.updateProfile.q", answerKey: "educatorSupportPage.faq.updateProfile.a" },
    { questionKey: "educatorSupportPage.faq.findJobs.q", answerKey: "educatorSupportPage.faq.findJobs.a" },
    { questionKey: "educatorSupportPage.faq.trackApplications.q", answerKey: "educatorSupportPage.faq.trackApplications.a" },
    ...
    <div className="space-y-8">
      ...
      <Card className="p-6">
        ...
        <form onSubmit={handleTicketSubmit} className="space-y-4">
          <div>
            <label htmlFor="ticketSubjectEducator" className="block text-sm font-medium text-gray-700 mb-1">{t('dashboard:supportPage.ticketForm.subjectLabel')}</label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="ticketMessageEducator" className="block text-sm font-medium text-gray-700 mb-1">{t('dashboard:supportPage.ticketForm.messageLabel')}</label>
            <textarea
