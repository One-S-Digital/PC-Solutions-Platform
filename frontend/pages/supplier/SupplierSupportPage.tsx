...
interface FAQItemProps {
  ...
  answerKey: string;   // Use key for answer
}
    ...
    <div className="space-y-8">
      ...
      <Card className="p-6">
        ...
        <form onSubmit={handleTicketSubmit} className="space-y-4">
          <div>
            <label htmlFor="ticketSubject" className="block text-sm font-medium text-gray-700 mb-1">{t('dashboard:supportPage.ticketForm.subjectLabel')}</label>
            <input
              type="text"
              id="ticketSubject"
              value={ticketSubject}
          ...
          <div>
            <label htmlFor="ticketMessage" className="block text-sm font-medium text-gray-700 mb-1">{t('dashboard:supportPage.ticketForm.messageLabel')}</label>
            <textarea
              id="ticketMessage"
              value={ticketMessage}
