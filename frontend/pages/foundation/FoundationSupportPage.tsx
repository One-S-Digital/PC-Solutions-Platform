    ...
    <div className="space-y-8">
      ...
      <Card className="p-6">
        ...
        <form onSubmit={handleTicketSubmit} className="space-y-4">
          <div>
              <label htmlFor="ticketSubjectFoundation" className="block text-sm font-medium text-gray-700 mb-1">{t('common:supportPage.ticketForm.subjectLabel')}</label>
            <input
              type="text"
          ...
          <div>
              <label htmlFor="ticketMessageFoundation" className="block text-sm font-medium text-gray-700 mb-1">{t('common:supportPage.ticketForm.messageLabel')}</label>
            <textarea
