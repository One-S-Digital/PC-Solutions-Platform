...
export const MOCK_FOUNDATION_USER: User = { 
  ...
  plan: 'Basic', // Added for feature locking
  memberSince: '2023-01-15T10:00:00Z', // Added for settings page
};
...
export const MOCK_SUPER_ADMIN_USER: User = {
  ...
  region: 'Switzerland',
  memberSince: '2022-01-01T10:00:00Z',
};
...
export const MOCK_SUPPLIER_USER: User = { 
  ...
  region: 'Zurich',
  plan: 'Suppliers',
  memberSince: '2023-05-10T10:00:00Z',
};
...
export const MOCK_SERVICE_PROVIDER_USER: User = {
  ...
  memberSince: '2023-06-20T10:00:00Z',
};
...
export const MOCK_EDUCATOR_USER: User = {
  ...
  region: 'Bern',
  memberSince: '2024-02-18T10:00:00Z',
};
...
export const MOCK_JOB_LISTINGS: JobListing[] = [
  { 
    id: 'job1', 
    title: 'Lead Educator (Bilingual)', 
    foundationId: MOCK_FOUNDATION_ORG_KINDERWELT.id,
    foundationName: 'KinderWelt Vaud', 
    location: 'Lausanne, Vaud', 
    contractType: 'CDI', 
    startDate: '2024-09-01', 
    applicationsReceived: 7, 
    status: 'Open', 
    description: 'Seeking an experienced and passionate Lead Educator to join our bilingual team. You will be responsible for curriculum development, classroom management, and mentoring junior staff in a Montessori-inspired environment.', 
    requirements: ['Degree in Early Childhood Education', '5+ years of experience in a daycare setting', 'Fluent in French and English', 'Montessori certification is a plus'],
    responsibilities: [
    ...
    salaryRange: 'CHF 65,000 - 75,000 per year',
    imageUrl: 'https://picsum.photos/seed/job1/400/250'
  },
];
...
export const ALL_USERS_MOCK: User[] = [
  ...
  MOCK_EDUCATOR_USER,
  {...MOCK_CANDIDATE_PROFILES[0], id: 'cand1', role: UserRole.EDUCATOR, memberSince: '2024-03-01T10:00:00Z'} as User, // Add Samuel D. as a user for messaging
];
...
export const MOCK_ORDERS: Order[] = [
    {
        ...
        foundationOrgId: MOCK_FOUNDATION_ORG_KINDERWELT.id,
        supplierId: MOCK_SUPPLIER_ORGANIZATION.id,
        supplierName: MOCK_SUPPLIER_ORGANIZATION.name,
        items: [
            {
                productId: 'p1',
                productName: 'Eco Wooden Blocks Set',
                quantity: 5,
                unitPrice: 49.99,
        ...
        status: OrderRequestStatus.FULFILLED,
...
export const MOCK_SUPPLIER_SETTINGS: SupplierSettings = {
  ...
  // [FIX] Corrected 'Zürich' to 'Zurich' to match the defined type.
  regionsServed: ['Zurich'],
  ...
  currentTier: 'Suppliers', nextInvoiceDate: '2024-08-01T00:00:00Z', stripePortalLink: '#',
...
export const MOCK_PROVIDER_SETTINGS: ProviderSettings = {
  ...
  currentTier: 'Service Providers', nextInvoiceDate: '2024-08-15T00:00:00Z', stripePortalLink: '#',
...
export const MOCK_FOUNDATION_SETTINGS: FoundationSettings = {
  companyName: MOCK_FOUNDATION_ORG_KINDERWELT.name,
  logoUrl: MOCK_FOUNDATION_ORG_KINDERWELT.logoUrl,
  coverImageUrl: MOCK_FOUNDATION_ORG_KINDERWELT.coverImageUrl,
  aboutText: MOCK_FOUNDATION_ORG_KINDERWELT.description || '',
  regionsServed: [MOCK_FOUNDATION_ORG_KINDERWELT.region as SwissCanton],
  languagesSpoken: ['FR', 'EN'],
  preferredContactMethod: 'Platform Form',
  avgResponseType: '< 24 h',
  newRequestEmailToggle: true,
  digestRadio: 'Daily',
  promoRedemptionAlertsToggle: false, // Not applicable for foundation
  autoRespondToggle: true,
  promoCodes: [], // Not applicable
  currentTier: MOCK_FOUNDATION_USER.plan,
  nextInvoiceDate: '2024-08-20T00:00:00Z',
  stripePortalLink: '#',
  timeZone: 'Europe/Zurich',
  currency: 'CHF',
  anonymisedBenchmarkDataOptIn: true,
...
export const MOCK_PRICING_PLANS: PricingPlan[] = [
  ...
  // Suppliers Plan
  {
    ...
    name: 'Suppliers',
    emoji: '💼',
    price: { monthly: 450, annually: 5000 },
    monthlyPriceText: 'CHF 450 / month',
    annualPlanText: 'CHF 5’000 / year (save 10%)',
    tagline: 'Perfect for: Food, equipment, and product suppliers who want direct access to Swiss daycares—without middlemen or wasted outreach.',
    description: '✨ Get your products in front of decision-makers, generate recurring bulk orders, and build long-term contracts.',
    features: [
      'Profile + unlimited product listings',
      'Structured order requests & status tracking',
      'Analytics (views, clicks, orders)',
      'Promo codes & redemption tracking',
      'Full visibility across all daycares',
  ...
  // Service Provider Plan
  {
    ...
    emoji: '⚙️',
    price: { monthly: 270, annually: 3000 },
    monthlyPriceText: 'CHF 270 / month',
    annualPlanText: 'CHF 3’000 / year (save 10%)',
    tagline: 'Perfect for: Legal, accounting, IT, coaching, training, and other professionals who want to secure recurring daycare clients at scale.',
    description: '✨ Fill your pipeline with high-trust contracts and appointments—without cold outreach or endless networking.',
    features: [
      'Profile + multi-service listings',
      'Appointment & quote requests',
      'Scheduling link integration (Calendly/Cal.com)',
      'Pipeline management tools',
      'Analytics (requests, regions, promo codes)',
      'Promo code options',
      'Email support & guided onboarding',
    ],
    isPopular: false,
...
// Mock Data for New System Monitoring
export const MOCK_SYSTEM_MONITORING_DATA: SystemMonitoringData = {
  ...
  metadata: {
    ...
    version: '2.5.1',
    uptimeMinutes: 525600, // 1 year
    lastHealthCheck: new Date(Date.now() - 1000 * 60 * 2).toISOString(), // 2 minutes ago
  },
  serverPerformance: {
    cpuUsage: 35.5,
    memoryUsage: 62.1,
  ...
  events: [
    { id: 'evt1', timestamp: new Date(Date.now() - 1000 * 60 * 1).toISOString(), type: 'Health Check', message: 'All systems returned a healthy status.' },
    { id: 'evt2', timestamp: new Date(Date.now() - 1000 * 60 * 60 * 2).toISOString(), type: 'Database Backup', message: 'Daily database backup completed successfully.' },
    { id: 'evt3', timestamp: new Date(Date.now() - 1000 * 60 * 60 * 8).toISOString(), type: 'Memory Alert', message: 'Memory usage exceeded 80% threshold. Auto-scaling triggered.' },
    { id: 'evt4', timestamp: new Date(Date.now() - 1000 * 60 * 60 * 24).toISOString(), type: 'API Improvement', message: 'Deployed new version of the API with performance enhancements.' },
  ],
};
...
// MOCK DATA FOR VENDOR-CLIENT RELATIONSHIP
export const MOCK_VENDOR_CLIENTS: VendorClient[] = [
    {
        id: 'vc-1',
        vendorId: MOCK_SUPPLIER_ORGANIZATION.id,
        orgId: MOCK_FOUNDATION_ORG_KINDERWELT.id,
        isActive: true,
        reason: VendorClientReason.CONTRACT,
        note: 'Annual contract for toy supplies. PO #12345',
        markedByUserId: MOCK_SUPPLIER_USER.id,
        markedAt: '2024-06-15T10:00:00Z',
    },
    {
        id: 'vc-2',
        vendorId: MOCK_SERVICE_PROVIDER_ORGANIZATION.id,
        orgId: 'orgOtherFoundation1', // Happy Kids Daycare
        isActive: false, // Inactive
        reason: VendorClientReason.TERMINATED,
        note: 'Contract ended last month.',
        markedByUserId: MOCK_SERVICE_PROVIDER_USER.id,
        markedAt: '2024-01-10T11:00:00Z',
        deactivatedAt: '2024-06-30T17:00:00Z'
    }
];