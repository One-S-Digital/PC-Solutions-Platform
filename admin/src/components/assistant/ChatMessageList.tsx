...
/**
 * Shared thread renderer for the admin AI assistant: message bubbles, tool
 * cards, next-step chips, and the streaming "thinking" bubble. Used by both
 * the floating AssistantPanel and the full-page assistant workspace.
 * (Admin-side port of frontend/components/assistant/ChatMessageList.tsx.)
 */
