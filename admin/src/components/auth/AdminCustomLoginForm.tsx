          ...
          <div className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 mb-6">
                Secure access to backend management and system administration.
              </p>
            </div>

            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="text-center p-3 bg-gray-50 rounded-lg">
                <Database className="h-6 w-6 text-indigo-600 mx-auto mb-1" />
                <p className="text-xs text-gray-600">Data Management</p>
              </div>
              <div className="text-center p-3 bg-gray-50 rounded-lg">
                <Users className="h-6 w-6 text-indigo-600 mx-auto mb-1" />
                <p className="text-xs text-gray-600">User Administration</p>
              </div>
              <div className="text-center p-3 bg-gray-50 rounded-lg">
                <Settings className="h-6 w-6 text-indigo-600 mx-auto mb-1" />
                <p className="text-xs text-gray-600">System Settings</p>
              </div>
              <div className="text-center p-3 bg-gray-50 rounded-lg">
                <Shield className="h-6 w-6 text-indigo-600 mx-auto mb-1" />
                <p className="text-xs text-gray-600">Security Monitor</p>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="mt-1 relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-10 py-2 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
