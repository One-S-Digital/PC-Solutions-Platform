  ...
  async getEducatorSettings(@Request() req) {
    ...
    return {
      ...
      data: {
        ...
        workExperienceItems: (user.workExperienceItems ?? []).map((item: any) => ({
          id: item.id,
        ...
        educationItems: (user.educationItems ?? []).map((item: any) => ({
          id: item.id,
          degree: item.degree,
          institutionName: item.institutionName,
        ...
        certificationItems: (user.certificationItems ?? []).map((item: any) => ({
          id: item.id,
          name: item.name,
