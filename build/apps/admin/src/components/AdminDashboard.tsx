      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <AdminCard className="p-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="inline-flex items-center px-2 py-1 rounded bg-green-100 text-green-700 text-sm">All Systems Operational</div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-admin-gray">{databaseStats?.connections} connections</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-admin-gray">{(systemMetrics?.network?.in ?? 0)} Mbps in</p>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <AdminMetric
            ...
            change={{ value: Math.abs(userStats?.newUsersToday || 0), type: 'increase' }}
          ...
          <AdminMetric
            ...
            change={{ value: Math.round(systemMetrics?.cpu.usage || 0), type: (systemMetrics && systemMetrics.cpu.usage > 80) ? 'decrease' : 'increase' }}
            icon={<CpuChipIcon className="h-6 w-6" />}
          />
          <AdminMetric
            label="Memory Usage"
            value={`${Math.round(systemMetrics?.memory.usage || 0)}%`}
            change={{ value: Math.round(systemMetrics?.memory.usage || 0), type: (systemMetrics && systemMetrics.memory.usage > 80) ? 'decrease' : 'increase' }}
                ...
                <div key={alert.id} className={`border-l-4 p-4 rounded-card ${
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="text-sm font-medium text-admin-charcoal">{alert.type.toUpperCase()}</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <AdminCard className="p-6">
            <div className="flex items-center mb-6">
              <CircleStackIcon className="h-6 w-6 text-admin-mint mr-3" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <AdminCard className="p-6">
            <h3 className="text-lg font-semibold text-admin-charcoal mb-4">User Overview</h3>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="text-center">
                <p className="text-sm text-admin-gray">Total Users</p>
                <p className="text-xl font-semibold text-admin-charcoal">{userStats?.totalUsers ?? 0}</p>
              </div>
              <div className="text-center">
                <p className="text-sm text-admin-gray">Active Users</p>
                <p className="text-xl font-semibold text-admin-charcoal">{userStats?.activeUsers ?? 0}</p>
              </div>
              <div className="text-center">
                <p className="text-sm text-admin-gray">New Today</p>
                <p className="text-xl font-semibold text-admin-charcoal">{userStats?.newUsersToday ?? 0}</p>
              </div>
            </div>
          </AdminCard>
          ...
          <AdminCard className="p-6">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <span className="text-sm text-admin-gray">Requests</span>
                <span className="text-sm font-medium text-admin-charcoal">{applicationStats?.requests ?? 0}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm text-admin-gray">Latency (p50)</span>
                <span className="text-sm font-medium text-admin-charcoal">{applicationStats?.latency?.p50 ?? 0}ms</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm text-admin-gray">Latency (p95)</span>
                <span className="text-sm font-medium text-admin-charcoal">{applicationStats?.latency?.p95 ?? 0}ms</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm text-admin-gray">Error rate</span>
                <span className="text-sm font-medium text-admin-charcoal">{(applicationStats?.errorRate ?? 0)}%</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm text-admin-gray">Throughput</span>
                <span className="text-sm font-medium text-admin-charcoal">{applicationStats?.throughput ?? 0} rps</span>
              </div>
            </div>
          </AdminCard>
        </div>
