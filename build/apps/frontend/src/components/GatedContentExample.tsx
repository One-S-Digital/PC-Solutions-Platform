  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-8">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold text-swiss-charcoal mb-4">
          Gated Content Examples
        </h1>
        <p className="text-gray-600">
          See how gated content works with different subscription plans
        </p>
        <div className="mt-4">
          <FeatureAccessBadge 
            featureKey="advanced_reports" 
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <div>
              <h3 className="text-xl font-semibold text-swiss-charcoal mb-3">
                Advanced Occupancy Analytics
              </h3>
              <div className="space-y-3">
                <div className="flex justify-between items-center p-3 bg-gray-50 rounded">
                  <span className="text-gray-600">Total Capacity</span>
                  <span className="font-semibold text-swiss-charcoal">150 children</span>
                </div>
                <div className="flex justify-between items-center p-3 bg-gray-50 rounded">
                  <span className="text-gray-600">Current Occupancy</span>
                  <span className="font-semibold text-swiss-charcoal">142 children</span>
                </div>
                <div className="flex justify-between items-center p-3 bg-gray-50 rounded">
              ...
              <div className="mt-4 p-4 bg-swiss-mint/10 rounded-lg">
                <h4 className="font-semibold text-swiss-charcoal mb-2">Recommendations</h4>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center p-3 bg-gray-50 rounded">
                  ...
                  <span className="font-semibold text-swiss-charcoal">142</span>
                </div>
                <div className="flex justify-between items-center p-3 bg-gray-50 rounded">
                  <span className="text-gray-600">Active Educators</span>
                  <span className="font-semibold text-swiss-charcoal">28</span>
                </div>
                <div className="flex justify-between items-center p-3 bg-gray-50 rounded">
              ...
              <div className="mt-4 flex items-center gap-2">
                ...
                <span className="text-sm text-green-600 font-medium">Available on your plan</span>
              </div>
            </div>
          </GatedContent>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-swiss-charcoal">Small Lock</h3>
              <FeatureLock featureKey="advanced_reports" size="sm" userPlan={featureAccess.userPlan} />
            </div>
            <p className="text-gray-600 text-sm">Small lock indicator for compact spaces</p>
          </div>
          
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-swiss-charcoal">Medium Lock</h3>
              <FeatureLock featureKey="bulk_upload" size="md" userPlan={featureAccess.userPlan} />
            </div>
            <p className="text-gray-600 text-sm">Standard lock indicator for most use cases</p>
          </div>
          
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-swiss-charcoal">Large Lock</h3>
              <FeatureLock featureKey="priority_support" size="lg" userPlan={featureAccess.userPlan} />
            </div>
            <p className="text-gray-600 text-sm">Large lock indicator for emphasis</p>
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="space-y-6">
          <div>
            <h3 className="text-lg font-semibold text-swiss-charcoal mb-3">Banner Style</h3>
            <UpgradeCTA
              featureKey="advanced_reports"
              upgradeBenefit={getFeatureBenefit('advanced_reports')}
              variant="banner"
          ...
          <div>
            <h3 className="text-lg font-semibold text-swiss-charcoal mb-3">Inline Style</h3>
            <UpgradeCTA
              featureKey="bulk_upload"
              upgradeBenefit={getFeatureBenefit('bulk_upload')}
              variant="inline"
          ...
          <div>
            <h3 className="text-lg font-semibold text-swiss-charcoal mb-3">Button Style</h3>
            <UpgradeCTA
              featureKey="priority_support"
              upgradeBenefit={getFeatureBenefit('priority_support')}
              variant="button"
