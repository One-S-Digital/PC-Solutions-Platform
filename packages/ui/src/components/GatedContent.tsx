  ...
  return (
    <>
      <div className={clsx("relative", className)}>
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-surface-1 to-transparent p-4">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-text-muted text-xs">{upgradeBenefit}</p>
        ...
        <div
          className="absolute inset-0 bg-transparent hover:bg-accent/5 transition-colors cursor-pointer"
          onClick={handleUpgradeClick}
          title={t(
            "gated.clickToUpgrade",
...
function UpgradeModal({
  ...
  const getFeatureBenefits = (key: string) => {
    const benefits: Record<string, string[]> = {
      advanced_reports: [
        t(
          "gated.benefits.advancedAnalytics",
  ...
  const handleUpgrade = () => {
    ...
    pricingUrl.searchParams.set("feature", featureKey);
        ...
        <div className="relative bg-surface-1 rounded-lg shadow-pop max-w-md w-full">
          ...
          <div className="p-6">
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-text-muted">{upgradeBenefit}</p>
            ...
            <div className="bg-surface-2 rounded-lg p-4 mb-6">
              <p className="text-text-muted text-sm italic">
                ...
                {t(
                  "gated.testimonial",
                  "Switching to Pro saved us hours each week.",
                )}
                &rdquo;
              </p>
